...
kick_powers = [10,90]
# kick_dirs = [SoccerDirection.GOAL_CENTER]
kick_dirs = [SoccerDirection.GOAL_CENTER, SoccerDirection.GOALIE_LEFT, SoccerDirection.GOALIE_RIGHT] # SoccerDirection.FORWARD
# env_name = 'EmptyGoal'
env_name = 'AgainstKeeper'
actions = ActionSpaceSoccerSimple(turn_dirs, dash_powers, kick_powers, kick_dirs)
features = FeaturesSoccerSmall(env_name, actions)
